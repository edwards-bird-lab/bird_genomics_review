...
tree = ET.parse("mitogenomes_osteichthyes.xml")
root = tree.getroot()

# open a file for writing

mitogenome_data = open('/Users/schmitty/Documents/CJS/projects/bird_genome_review/mitogenomes_osteichthyes.csv', 'w')
